...
class StaticCheckerTestSuite(unittest.TestCase):
    ...
    def testTwoSeparateScopes(self):
        self.assertEqual(mainStaticChecker('Tests/testTwoSeparateScopes.txt'), open('Tests/answerTwoSeparateScopes.txt','r').read())
    def testOneRedeclaredVariable(self):
        self.assertEqual(mainStaticChecker('Tests/testOneRedeclaredVariable.txt'), open('Tests/answerOneRedeclaredVariable.txt','r').read())
    def testThreeRedeclaredVariables(self):
        self.assertEqual(mainStaticChecker('Tests/testThreeRedeclaredVariables.txt'), open('Tests/answerThreeRedeclaredVariables.txt','r').read())
    ...
    def testIfTypeCheck(self):
        self.assertEqual(mainStaticChecker('Tests/testIfTypeCheck.txt'), open('Tests/answerIfTypeCheck.txt','r').read())
    ...
    def testMediumProgramScopes(self):
        self.assertEqual(mainStaticChecker('Tests/testMediumProgramScopes.txt'), open('Tests/answerMediumProgramScopes.txt','r').read())
