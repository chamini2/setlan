...
def lexicografico(archivo):
	...
	if (len(listaErrores) == 0):
		for a in tokensEncontrados:
			...
			if (a.type == "Llave_Cierra")|(a.type == "Llave_Abre")|(a.type == "GreaterEqual")|(a.type == "NumElemConj")|(a.type == "Par_Cierra")|(a.type == "LessEqual"):
				print "	value (",
			else:
				print "		value (",
			if (a.type == "ID")|(a.type == "String"):
				...
				print str(a.value) + " )",
			if (a.lineno > 1):
				print "(Linea " + str(a.lineno) + ", Columna " + str(find_column(data2,a)) + ")"
			else:
				print "(Linea " + str(a.lineno) + ", Columna " + str(find_column(data2,a)+1) + ")"
		lexer.lineno =1
	else:
		for b in listaErrores:
			if (b.lineno > 1):
				print "Error: Se encontró un caracter inesperado " + "'"+b.value[0]+"'" + " en Linea " + str(b.lineno)+", Columna "+str(find_column(data2,b)) + "."
			else:
				print "Error: Se encontró un caracter inesperado " + "'"+b.value[0]+"'" + " en Linea " + str(b.lineno)+", Columna "+str(find_column(data2,b)+1) + "."
			lexer.lineno =1
		exit()
